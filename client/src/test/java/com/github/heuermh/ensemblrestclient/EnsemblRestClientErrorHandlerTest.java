...
/**
 * Unit test for EnsemblRestClientErrorHandler.
 *
 * @author  Michael Heuer
 */
public final class EnsemblRestClientErrorHandlerTest {
    ...
    private EnsemblRestClientErrorHandler errorHandler;
    ...
    public void setUp() {
        ...
        errorHandler = new EnsemblRestClientErrorHandler();
    }
    ...
    public void testHandleErrorNullRetrofitError() {
        errorHandler.handleError(null);
    }

    @Test
    public void testConversionError() {
        EnsemblRestClientException exception = (EnsemblRestClientException) errorHandler.handleError(conversionError);
    ...
    public void testHttpError() {
        EnsemblRestClientException exception = (EnsemblRestClientException) errorHandler.handleError(httpError);
        assertNotNull(exception);
        assertEquals("url", exception.getUrl());
        assertEquals(404, exception.getStatus());
        assertEquals("Not found", exception.getReason());
    ...
    public void testNetworkError() {
        EnsemblRestClientException exception = (EnsemblRestClientException) errorHandler.handleError(networkError);
        assertNotNull(exception);
        assertEquals("url", exception.getUrl());
    ...
    public void testUnexpectedError() {
        EnsemblRestClientException exception = (EnsemblRestClientException) errorHandler.handleError(unexpectedError);
        assertNotNull(exception);
        assertEquals("url", exception.getUrl());
        assertEquals(-1, exception.getStatus());
        assertEquals("", exception.getReason());
